...
class DataJarak extends StatefulWidget {
  ...
  const DataJarak({Key? key, required this.email}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Data Jarak", style: TextStyle(color: Colors.black87)),
        actions: [
          IconButton(
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      // Text("Date: ${_csvTable[index][0].toString()}"),
