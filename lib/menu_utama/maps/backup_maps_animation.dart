  ...
  void getData({DateTime? startDate, DateTime? endDate}) {
    ...
    query.onValue.listen((event) {
      ...
      if (data != null && data is Map<dynamic, dynamic>) {
        var latestJourney = data.values.first;
        ...
        child: Padding(
          ...
          child: Card(
            child: Column(
              children: [
                SizedBox(height: 10,),
                Text('Data Lokasi Perjalanan', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        child: Icon(Icons.filter_list, color: texticon, size: 18,),
                      ),
                    ),
                    SizedBox(width: 10,),
                  ],
                ...
                Expanded(
                  ...
                  child: distance != null ? Center(
                    child: Text(
                      'Jarak Perjalanan: ${distance.toStringAsFixed(2)} km',
